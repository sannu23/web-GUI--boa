...
<% end if %>
        ...
        <TR>
          ...
          <TD width=7 background=/img/panel3.gif></TD>
          <TD>
            <FORM name=ConfigForm id=ConfigForm action="/cgi-bin/sta-device.asp" method="post">
              ...
              <TR>
                ...
                <TD>
                  <TABLE cellSpacing=0 cellPadding=0 border=0>
                    <TBODY>
                    <TR id=secUsername>
                      <TD width=177 height="30"><%tcWebApi_get("String_Entry","UserManage7Text","s")%></TD>
                      <TD width=169>
                    ...
                    <TR id=trNewUsername name=trNewUsername >
                      <TD width=177 height="30"><%tcWebApi_get("String_Entry","UserManage8Text","s")%></TD>
                    ...
                    <TR id=TroldPassword name=TroldPassword >
                      <TD width=177 height="30"><%tcWebApi_get("String_Entry","UserManage9Text","s")%></TD>
                      <TD><INPUT id=oldPassword type=password maxLength=35 
                        size=15 name=oldPassword></TD></TR>
                    <TR>
                      <TD width=177 height="30"><%tcWebApi_get("String_Entry","UserManage10Text","s")%></TD>
                    ...
                    <TR>
                      <TD width=177 height="30"><%tcWebApi_get("String_Entry","UserManage11Text","s")%></TD>
