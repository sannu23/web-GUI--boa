              ...
              <TR>
                ...
                <TD width=480>
                  <FORM id="LineTestForm" name="LineTestForm" action="/cgi-bin/diag-servicediagnose.asp" method="post">
                  	<input type="hidden" id="linetest_commitflag" name="linetest_commitflag" value="0">
                  	<input type="hidden" id="linetest_TestType" name="linetest_TestType" value="<%TCWebApi_get("VoIPTest_Entry0","TestSelector","s")%>">
                  	<input type="hidden" id="TestStateVal" name="TestStateVal" value="0">
                  	<input type="hidden" id="TestSelectorVal" name="TestSelectorVal" value="0">
                  ...
                  <TABLE border=1 cellSpacing=0 cellPadding=4 width="80%">
			        ...
			        <TD width="45%" align=right ><%If tcWebApi_get("VoIPTest_Entry0","LineTestData_vDcDiff","h") <> "N/A" Then tcWebApi_get("VoIPTest_Entry0","LineTestData_vDcDiff","s") end if%>
                        ...
                        &nbsp;</TD>
	                <TD align="center">
                       <INPUT onclick="startLineTest_vDcDiff()" type='button' value=' 应用 ' id="btnLineTest_vDc" name="btnLineTest"> 
                    </TD> 
                  ...
                  <TABLE border=1 cellSpacing=0 cellPadding=4 width="80%">
			        ...
			        <TD width="45%" align=right ><%If tcWebApi_get("VoIPTest_Entry0","LineTestData_rtr","h") <> "N/A" Then tcWebApi_get("VoIPTest_Entry0","LineTestData_rtr","s") end if%>
                        ...
                        &nbsp; </TD>
	                <TD align="center">
                       <INPUT onclick="startLineTest_rtr()" type='button' value=' 应用 ' id="btnLineTest_rtr" name="btnLineTest"> 
                    </TD> 
              ...
              <TR>
                ...
                <TD>
                  <FORM id="SimulateTestForm" name="SimulateTestForm" action="/cgi-bin/diag-servicediagnose.asp" method="post">
                    <input type="hidden" id="simulatetest_TestType" name="simulatetest_TestType" value="<%TCWebApi_get("VoIPTest_Entry0","TestSelector","s")%>">
                    <input type="hidden" id="simulatetest_commitflag" name="simulatetest_commitflag" value="0">
                    <input type="hidden" id="TestStateSimVal" name="TestStateSimVal" value="0">
                  	<input type="hidden" id="TestSelectorSimVal" name="TestSelectorSimVal" value="0">    
                  	<input type="hidden" id="TestTypeSimVal" name="TestTypeSimVal" value="0">
                  ...
                  <TABLE border=1 cellSpacing=0 cellPadding=4 width="80%">
	                ...
	                <TD align="center">
                       <INPUT onclick="startSimulateTest()" type='button' value=' 测试 ' id="btnSimulateTest" name="btnSimulateTest"> 
                    </TD> 
