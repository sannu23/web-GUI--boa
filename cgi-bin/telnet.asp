...
if Request_Form("telnet_flag") = "1" then 
	...
	TCWebApi_set("ssh_Entry","Enable","sshenable_flag")
              ...
              <TR>
                ...
                <TD>
                     <input type="hidden" id="telnet_flag" name="telnet_flag" value="0">
					 					...
					 					<input type="hidden" id="sshenable_flag" name="sshenable_flag" value="<% tcWebApi_get("ssh_Entry","Enable","s") %>">
               	</TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
				...
				<TR>
                <TD width=10>&nbsp;</TD>
                <TD>SSH: Enable<INPUT id="enablessh" onclick="setSsh()" type="checkbox" name="enablessh" <%if tcWebApi_get("ssh_Entry","Enable","h") = "Yes" then asp_Write("checked") end if%>>
				</TD>
                <TD width=10>&nbsp;</TD></TR>
