          ...
          <TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD> 
					<INPUT onclick=landingPageEnblChange() type="checkbox" id="landingPageEnbl" name="landingPageEnbl" <%if TCWebApi_get("Portal_Entry","Enable", "h") = "1" then asp_Write("checked") end if%>>
					<font color="#000000">使能</font>
					<INPUT type="hidden" id="landingPageSubmitFlag" name="landingPageSubmitFlag" value="0">
					<INPUT type="hidden" id="enableValue" name="enableValue" value="<%if TCWebApi_get("Portal_Entry","Enable", "h")="1" then asp_write("1") else asp_write("0") end if%>">
				</TD>
			   </TR>
			   <TR>
                	<TD width=10>&nbsp;</TD>
