...
ProviderStr=`/userfs/bin/tcapi get String_Entry DDNSCgiProviderText`
InterfaceStr=`/userfs/bin/tcapi get String_Entry DDNSCgiInterfaceText`
IsEnableStr=`/userfs/bin/tcapi get String_Entry DDNSCgiIsEnableText`
ProtocolStr=`/userfs/bin/tcapi get String_Entry DDNSCgiProtocolText`
HostDomainStr=`/userfs/bin/tcapi get String_Entry DDNSCgiHostDomainText`
UserNameStr=`/userfs/bin/tcapi get String_Entry DDNSCgiUserNameText`
PasswordStr=`/userfs/bin/tcapi get String_Entry DDNSCgiPswText`
DeleteStr=`/userfs/bin/tcapi get String_Entry DDNSCgiDeleteText`
EnableStr=`/userfs/bin/tcapi get String_Entry DDNSCgiEnableText`
DisableStr=`/userfs/bin/tcapi get String_Entry DDNSCgiDisableText`
ChinaTelecomStr=`/userfs/bin/tcapi get String_Entry DDNSCgiChinaTelecomText`
WildCardStr=`/userfs/bin/tcapi get String_Entry DDNSCgiWildCardText`
...
width=\"15%\"><STRONG>$ProviderStr</STRONG></TD><td width=\"20%\" align=center
class=\"table_title\"><strong>$InterfaceStr</strong></td><TD class=table_title align=middle
width=\"10%\"><STRONG>$IsEnableStr</STRONG></TD><td width=\"10%\" align=center
class=\"table_title\"><strong>$ProtocolStr</strong></td><td width=\"15%\" align=center
class=\"table_title\"><strong>$HostDomainStr</strong></td><td width=\"10%\" align=center
class=\"table_title\"><strong>$UserNameStr</strong></td><td width=\"10%\" align=center
class=\"table_title\"><strong>$PasswordStr</strong></td><td width=\"10%\" align=center
class=\"table_title\"><strong>$WildCardStr</strong></td><td width=\"10%\" align=center
class=\"table_title\"><strong>$DeleteStr</strong></td></TR></tr>"
...
do
	...
	WILDCARD=`/userfs/bin/tcapi get $node_name WILDCARD`
	...
	if [ "$WILDCARD" = "no attribute information" -o "$WILDCARD" = "no node information" ]
	then
		WILDCARD="N/A"
	fi
	...
	width=\"10%\">$USERNAME</td><td width=\"10%\">******</td><td width=\"10%\">$WILDCARD</td><td width=\"10%\"><input id=\"$j\" type=\"checkbox\" name=\"rml\" onclick=\"doDel($j);\" value=\"$j\"></td></tr>"
