      ...
      <table height="90" cellspacing="0" cellpadding="0" width="808" background="/img/framelogo.jpg" border="0">
        ...
        <tr>
          ...
          <td valign="bottom" align="right" width="358">
            <table id="table8" name="table8" cellspacing="0" cellpadding="0" border="0">
              <tbody>
              <tr>
                <td valign="bottom" align="right"><span class="curUserName">&nbsp; 
                  </span></td>
                <td class="welcom" valign="bottom" align="middle" width="120">欢迎您！ </td>
                <td valign="bottom" width="50"><a onclick="DoLogout()" href="/cgi-bin/logout.cgi" id=logOut name=logOut target="_top"><span class="logout">退出 
        ...
        <tr>
          ...
          <td valign="top" width="170" background="/img/panel4.gif" rowspan="5">
            <table cellspacing="0" cellpadding="20" width="100%" border="0" height="100%">
              <tbody>
              <tr>
                <td valign="top"><a href="/cgi-bin/help_content.asp#手机连接管理" target="_blank"><img height="34" src="<%tcWebApi_get("String_Entry","IMGHelpText","s")%>" width="40" border="0"></a></td>
