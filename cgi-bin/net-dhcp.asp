...
{
alert("IPPhone IP STB ͻ!");
return false;
}
else if (ipConfilt (dhcpEthStartFrag.value, dhcpEthEndFrag.value,dhcpStart1_3, dhcpEnd1_3))
{
alert("IPPhone IP Cameraͻ!");
return false;
}
else if (ipConfilt (dhcpEthStartFrag.value, dhcpEthEndFrag.value,dhcpStart1_4, dhcpEnd1_4))
{
alert("IPPhone IP Computer ͻ!");
return false;
}
...
{
alert("IPCamera IP STB ͻ!");
return false;
}
else if (ipConfilt (dhcpEthStartFrag.value, dhcpEthEndFrag.value,dhcpStart1_2, dhcpEnd1_2))
{
alert("IPCamera IP Phone ͻ!");
return false;
}
else if (ipConfilt (dhcpEthStartFrag.value, dhcpEthEndFrag.value,dhcpStart1_4, dhcpEnd1_4))
{
alert("IPCamera IP Computer ͻ!");
return false;
}
...
if(!ipIsInIP(dhcpEthStartFrag.value, dhcpEthEndFrag.value, dhcpEthStart.value , dhcpEthEnd.value))
{
alert("IPComputerҪIP֮�⡣");
return false;
}
else if (ipConfilt (dhcpEthStartFrag.value, dhcpEthEndFrag.value,dhcpStart1_1, dhcpEnd1_1))
{
alert("IPComputer IP STB ͻ!");
return false;
}
else if (ipConfilt (dhcpEthStartFrag.value, dhcpEthEndFrag.value,dhcpStart1_2, dhcpEnd1_2))
{
alert("IPComputer IP Phone ͻ!");
return false;
}
else if (ipConfilt (dhcpEthStartFrag.value, dhcpEthEndFrag.value,dhcpStart1_3, dhcpEnd1_3))
{
alert("IPComputer IP Camera ͻ!");
return false;
}
...
function setDhcpStaticIPAddr(StaticIP)
{
	with (document.forms[0])
	{
		...
		{
			alert('<%tcWebApi_get("String_Entry","LANJS39Text","s")%> "' + StaticIP + '" <%tcWebApi_get("String_Entry","LANJS40Text","s")%>');
			return;
		}
	}
}
function setDhcpStaticMACAddr(StaticMAC)
{
	with (document.forms[0])
	{
		...
		{
			alert('<%tcWebApi_get("String_Entry","LANJS41Text","s")%> "' + StaticMAC + '" <%tcWebApi_get("String_Entry","LANJS42Text","s")%>');
			return false;
		}
	}
}
...
function btnAdd()
{
	...
	if(!(isSameSubNet(ethIpAddress.value, ethSubnetMask.value, StaticIpAddress.value, ethSubnetMask.value))
		|| (isBroadcastIp(StaticIpAddress.value, ethSubnetMask.value) == true))
	{
		alert('<%tcWebApi_get("String_Entry","LANJS43Text","s")%> "' + StaticIpAddress.value + '" <%tcWebApi_get("String_Entry","LANJS44Text","s")%>');
		return false;
	}
...
<% if tcwebApi_get("WebCustom_Entry","isOptronixCustomSupported","h") = "Yes" then %>
                      <input type="hidden" name="Static_Flag" id="Static_Flag" value="0">
                      <input type="hidden" name="add_num" id="add_num" value="<% tcWebApi_get("Dhcpd","Static_Num","s") %>">
...
<% end if %>  
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 border=0>		  
                    ...
                    <TR id="dhcpstartaddr">
                      ...
                      <TD>&nbsp;&nbsp;&nbsp;</TD>
                      <!--<TD style="display:block"><INPUT maxLength=15 id="dhcpEthStartFrag" name="dhcpEthStartFrag" value="<%if tcWebApi_get("Dhcpd_Option60","start","h" ) <> "N/A" then tcWebApi_get("Dhcpd_Option60","start","s") end if %>"></TD>-->
                      </TR>
                    <TR id="dhcpendaddr">
                      ...
                      <TD>&nbsp;&nbsp;&nbsp;</TD>
                      <!--<TD style="display:block"><INPUT maxLength=15 id="dhcpEthEndFrag" name="dhcpEthEndFrag" value="<%if tcWebApi_get("Dhcpd_Option60","pool_count","h" ) <> "N/A" then tcWebApi_get("Dhcpd_Option60","pool_count","s") end if %>"></TD>-->
                      </TR>
                    <TR id="dhcplease">
...
<% if tcwebApi_get("WebCustom_Entry","isOptronixCustomSupported","h") = "Yes" then %>
                    <TR>
						<TD width=10>&nbsp;</TD>
						<TD align=left width=307><B><%tcWebApi_get("String_Entry","LANDHCPstaticText","s")%></B></TD>
						<TD width=10>&nbsp;</TD>
                    </TR>
                    <TR>
						<TD width=10>&nbsp;</TD>
						<TD align=left width=307>
							<TABLE>
								<TR>
									...
									<TR align="center">
										<TD width="150" align="center" width="25%" > IP </TD>
										<TD width="150" align="center" width="35%" > MAC </TD>
										<TD width="50" align="center" width="20%" > <%tcWebApi_get("String_Entry","DeleteselectText","s")%> </TD>
									</TR>
									<%if tcwebApi_get("Dhcpd_Entry0","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry0","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry0","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(0)" value="0"></td>
									</tr>
									<%end if%>
									<%if tcwebApi_get("Dhcpd_Entry1","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry1","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry1","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(1)" value="1"></td>
									</tr>
									<%end if%>
									<%if tcwebApi_get("Dhcpd_Entry2","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry2","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry2","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(2)" value="2"></td>
									</tr>
									<%end if%>
									<%if tcwebApi_get("Dhcpd_Entry3","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry3","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry3","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(3)" value="3"></td>
									</tr>
									<%end if%>
									<%if tcwebApi_get("Dhcpd_Entry4","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry4","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry4","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(4)" value="4"></td>
									</tr>
									<%end if%>
									<%if tcwebApi_get("Dhcpd_Entry5","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry5","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry5","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(5)" value="5"></td>
									</tr>
									<%end if%>
									<%if tcwebApi_get("Dhcpd_Entry6","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry6","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry6","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(6)" value="6"></td>
									</tr>
									<%end if%>
									<%if tcwebApi_get("Dhcpd_Entry7","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry7","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry7","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(7)" value="7"></td>
									</tr>
									<%end if%>
									<%if tcwebApi_get("Dhcpd_Entry8","IP","h")<>"N/A" then%>
									<tr>
									 <td width="150" align=center> <% tcwebApi_get("Dhcpd_Entry8","IP","s") %> </td>
									<td width="150" align=center><% tcwebApi_get("Dhcpd_Entry8","MAC","s") %></td>
									<td width="50" align=center><input type=checkbox id="rml" name="rml" onclick="doDel(8)" value="8"></td>
									</tr>
									<%end if%> 
									</TABLE>
									</TD>		
						...
						<TD align=left width=307>
							<TABLE>
								<tbody>
									<TR>
									  <TD>
										<INPUT onclick="btnAdd()" id=buttonAdd name=buttonAdd type=button value="<%tcWebApi_get("String_Entry","DhcpButtonstcAddText","s")%>">
									  </TD>
									  <TD>
										<INPUT onclick="btnDel()" id=buttonDel name=buttonDel type=button value="<%tcWebApi_get("String_Entry","DhcpButtonstcDelText","s")%>">
									  </TD>
									</TR>
								</tbody>
							</TABLE>
