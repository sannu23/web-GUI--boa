                            ...
                            <TBODY>
                                <TR>
                                    <TD class=Item_L2 width=157 bgColor=#e7e7e7 height=30>
                                        <P>
                                            <a href='/cgi-bin/app-VoIP.asp' id=App_Voip name=App_Voip class=Item_L2 style="font-weight:normal;text-decoration: none;">
                                                宽带电话基本设置
                                            </a>
                                        </P>
                                    </TD>
                                                                    ...
                                                                    <TBODY>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <SELECT style="WIDTH: 125px" name=PhyList id=PhyList>
                                                                                </SELECT>
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <SELECT style="WIDTH: 125px" id=RingVoltage name=RingVoltage onchange=setRingVoltagePara()
                                                                                size=1>
                                                                                    <OPTION selected value=0>
                                                                                        74Vrms
                                                                                    </OPTION>
                                                                        ...
                                                                        <TR id=TrUserDefineRingVoltage>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" name=UserDefineRingVoltage id=UserDefineRingVoltage type=text>
                                                                                &nbsp; (单位：Vrms)
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" id=RingDCVoltageOverlapped name=RingDCVoltageOverlapped type=text>
                                                                                &nbsp; (单位：V)
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <SELECT style="WIDTH: 125px" id=SendGain name=SendGain>
                                                                                    <OPTION value=-6db>
                                                                                        -6db
                                                                                    </OPTION>
                                                                                    <OPTION value=-5.5db>
                                                                        ...
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <SELECT style="WIDTH: 125px" name=ReceiveGain id=ReceiveGain>
                                                                                    <OPTION value=0db>
                                                                                        0db
                                                                                    </OPTION>
                                                                                    <OPTION value=-0.5db>
                                                                        ...
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" id=HookFlashDownTime name=HookFlashDownTime type=text>
                                                                                &nbsp;（单位：毫秒）
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" id=HookFlashUpTime name=HookFlashUpTime type=text>
                                                                                &nbsp;（单位：毫秒）
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" id=OnhookConfirmTime name=OnhookConfirmTime type=text>
                                                                                &nbsp;（单位：毫秒）
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                        ...
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" id=Current name=Current type=text>
                                                                                &nbsp;（单位：毫安）
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <SELECT style="WIDTH: 125px" id=ClipFormat  name=ClipFormat onchange=setFskClipPara()>
                                                                        ...
                                                                        <TR id=TrFskTime>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" name=FskTime id=FskTime type=text>
                                                                                &nbsp;（单位：毫秒）
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <SELECT style="WIDTH: 125px" id=ClipTransWhen name=ClipTransWhen>
                                                                        ...
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT id=EnableDspTemplate name=EnableDspTemplate onclick=setDspTemplatePara() type=checkbox>
                                                                            </TD>
                                                                        </TR>
                                                                        <TR id=TrWorkMode>
                                                                            <TD style="WIDTH: 20%" class=table1_left>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <SELECT style="WIDTH: 125px" id=WorkMode name=WorkMode>
                                                                        ...
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" id=shorttimer name=shorttimer type=text>
                                                                                &nbsp;（单位：秒）
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
                                                                            ...
                                                                            <TD class=table1_right colSpan=3>
                                                                                <INPUT style="WIDTH: 125px" id=longtimer name=longtimer type=text>
                                                                                &nbsp;（单位：秒）
                                                                            </TD>
                                                                        </TR>
                                                                        <TR>
