          ...
          <TD>
            <FORM name="ConfigForm" action="/cgi-bin/cwmpsetting.asp" method="post">
              ...
              <TR>
                ...
                <TD>productclass</TD>
                <TD>
									<INPUT maxLength=63 id="productclass" name="productclass" value="<%if TCWebApi_get("RegInfo_Entry","productclass","h" ) <> "N/A" then TCWebApi_get("RegInfo_Entry","productclass","s" ) end if %>"> 
              ...
              <TR>
                ...
                <TD>
									<INPUT maxLength=63 id="manufacturerOUI" name="manufacturerOUI" value="<%if TCWebApi_get("RegInfo_Entry","manufacturerOUI","h" ) <> "N/A" then TCWebApi_get("RegInfo_Entry","manufacturerOUI","s" ) end if %>"> 
               	</TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>serialnum</TD>
                <TD>
									<INPUT maxLength=127 id="serialnum" name="serialnum" value="<%if TCWebApi_get("RegInfo_Entry","serialnum","h" ) <> "N/A" then TCWebApi_get("RegInfo_Entry","serialnum","s" ) end if %>"> 
               	</TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD>Manufacturer</TD>
                <TD>
									<INPUT maxLength=63 id="Manufacturer" name="Manufacturer" value="<%if TCWebApi_get("RegInfo_Entry","Manufacturer","h" ) <> "N/A" then TCWebApi_get("RegInfo_Entry","Manufacturer","s" ) end if %>"> 
               	</TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
                ...
                <TD>
									<INPUT maxLength=63 id="CustomerSWVersion" name="CustomerSWVersion" value="<%if TCWebApi_get("RegInfo_Entry","CustomerSWVersion","h" ) <> "N/A" then TCWebApi_get("RegInfo_Entry","CustomerSWVersion","s" ) end if %>"> 
               	</TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
                ...
                <TD>
									<INPUT maxLength=63 id="CustomerHWVersion" name="CustomerHWVersion" value="<%if TCWebApi_get("RegInfo_Entry","CustomerHWVersion","h" ) <> "N/A" then TCWebApi_get("RegInfo_Entry","CustomerHWVersion","s" ) end if %>"> 
               	</TD>
                <TD width=10>&nbsp;</TD></TR>
              <TR>
                <TD width=10>&nbsp;</TD>
