...
echo "<html><head></head><script language=\"JavaScript\">function CtrClickSetting(index,checked){ var f = parent.document.PORTTRIGGERINGList_form; switch(index){ case 0:if(checked) f.PortTriggeringList_Cntr0.value = 1;else f.PortTriggeringList_Cntr0.value = 0; break; case 1: if(checked) f.PortTriggeringList_Cntr1.value = 1; else f.PortTriggeringList_Cntr1.value = 0; break; case 2: if(checked) f.PortTriggeringList_Cntr2.value = 1; else f.PortTriggeringList_Cntr2.value = 0; break; case 3: if(checked) f.PortTriggeringList_Cntr3.value = 1; else f.PortTriggeringList_Cntr3.value = 0; break; case 4: if(checked) f.PortTriggeringList_Cntr4.value = 1; else f.PortTriggeringList_Cntr4.value = 0; break; case 5: if(checked) f.PortTriggeringList_Cntr5.value = 1; else f.PortTriggeringList_Cntr5.value = 0; break; case 6: if(checked) f.PortTriggeringList_Cntr6.value = 1; else f.PortTriggeringList_Cntr6.value = 0; break; case 7: if(checked) f.PortTriggeringList_Cntr7.value = 1; else f.PortTriggeringList_Cntr7.value = 0; break; }}"
echo -e "\tvar virstrtmp = parent.ary_strings;\n\tvar vir_obj = {};\n\tfor(var i=0; virstrtmp[i][0] != \"\"; i++) vir_obj[virstrtmp[i][0]]=virstrtmp[i][1];\n"
echo "</script><body><table width=\"100%\" height=\"100%\" border=\"1\" cellpadding=\"0\" cellspacing=\"0\" bordercolor=\"#CCCCCC\" bgcolor=\"#FFFFFF\"><tr height=\"10%\"><td align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerClear\"]);</script></font></strong></td>"
echo "<td align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerApp\"]);</script></font></strong></td><td colspan=\"3\" align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerRag\"]);</script></font></strong></td><td colspan=\"3\" align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerOpen\"]);</script></font></strong></td></tr>"
echo "<tr><td align=center class=\"tabdata\">&nbsp;</td><td align=center class=\"tabdata\">&nbsp;</td><td align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerSPort\"]);</script></font></strong></td><td align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerEPort\"]);</script></font></strong></td><td align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerProtocol\"]);</script></font></strong></td>"
echo "<td align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerSPort\"]);</script></font></strong></td><td align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerEPort\"]);</script></font></strong></td><td align=center class=\"tabdata\"><strong><font color=\"#000000\" size=2><script>document.writeln(vir_obj[\"porttriggerProtocol\"]);</script></font></strong></td></tr>"
i=0
tmpstr=""
