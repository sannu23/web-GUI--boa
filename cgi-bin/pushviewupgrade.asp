...
<TABLE style="POSITION: relative" borderColor="#e7e7e7" height="45%" cellSpacing="0" cellPadding="0" align="center" bgColor="#e7e7e7" border="0">
  ...
  <TR>
    <TD align=center colSpan=3>
    	<input type="hidden" id="pushviewcommit" name="pushviewcommit" value="0">
    	<input type="hidden" id="pushviewsel" name="pushviewsel" value="unset">
	 <INPUT id="btnSubmit_Upgrade" onclick="SubmitForm(1)" type="button" value="升 级" name="btnSubmit_Upgrade">&nbsp;
	 
	 <INPUT id="btnSubmit_NoUpgrade" onclick="SubmitForm(2)" type="button" value="不升级" name="btnSubmit_NoUpgrade">&nbsp;
