...
{	
		...
		with (getElById('ConfigForm'))
		{
			...
			tdResultElement.innerHTML = '<P><strong><font color="#FF0000" size="2"><%tcWebApi_get("String_Entry","UserManageOldPasswordErrorText","s")%></font></strong></P>';
		}
}
</SCRIPT>
        ...
        <TR>
          ...
          <TD>
            <FORM name=ConfigForm>
              ...
              <TR>
                <TD width=10>&nbsp;</TD>
                <TD><A href="/cgi-bin/mag-account.asp"><SPAN class=logout><%tcWebApi_get("String_Entry","UserManageBackToResetText","s")%></SPAN></A></TD>
