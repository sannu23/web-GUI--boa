...
<td width="33%"><input type="button" id="btnOK" name="btnOK" value="确定" style="width:60" onClick="onOK();"></td>
<td width="47%"><input type="button" id="btnCancel" name="btnCancel" value="重置" style="width:60" onClick="onReset();"></td>
</tr>
</table>
</td>
</tr>
...
<div id="buttonOK" >
<input type="button" id="btnReturn" name="btnReturn" value="返回" style="width:60" onClick="onReturn();">
</div>
</td>
</tr>
