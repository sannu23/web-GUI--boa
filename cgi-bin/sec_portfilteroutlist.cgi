...
FNStr=`/userfs/bin/tcapi get String_Entry PortFilter4Text`
PrStr=`/userfs/bin/tcapi get String_Entry PortFilter5Text`
SAStr=`/userfs/bin/tcapi get String_Entry PortFilter6Text`
SPortStr=`/userfs/bin/tcapi get String_Entry PortFilter7Text`
DStr=`/userfs/bin/tcapi get String_Entry PortFilter8Text`
DPStr=`/userfs/bin/tcapi get String_Entry PortFilter9Text`
EStr=`/userfs/bin/tcapi get String_Entry PortFilter10Text`
DeleteStr=`/userfs/bin/tcapi get String_Entry PortFilter27Text`
EnableStr=`/userfs/bin/tcapi get String_Entry PortFilter2Text`
DisableStr=`/userfs/bin/tcapi get String_Entry PortFilter3Text`

echo "<tr><td><table width=\"450\" border=\"1\" align=center cellpadding=\"3\" cellspacing=\"0\" bordercolor=\"#CCCCCC\"
bgcolor=\"#FFFFFF\"><tr><TD class=table_title align=middle width=\"18%\"><STRONG>$FNStr</STRONG></TD><td width=\"10%\" align=center
class=\"table_title\"><strong>$PrStr</strong></td><TD class=table_title align=middle
width=\"14%\"><STRONG>$SAStr</STRONG></TD><td width=\"12%\" align=center
class=\"table_title\"><strong>$SPortStr</strong></td><td width=\"12%\" align=center
class=\"table_title\"><strong>$DStr</strong></td><td width=\"12%\" align=center
class=\"table_title\"><strong>$DPStr</strong></td><td width=\"12%\" align=center
class=\"table_title\"><strong>$EStr</strong></td><td width=\"10%\" align=center
