...
FRuleStr=`/userfs/bin/tcapi get String_Entry MACFilter11Text`
MACAStr=`/userfs/bin/tcapi get String_Entry MACFilter12Text`
EnableStr=`/userfs/bin/tcapi get String_Entry MACFilter13Text`
DeleteStr=`/userfs/bin/tcapi get String_Entry MACFilter14Text`
Enable1Str=`/userfs/bin/tcapi get String_Entry MACFilter15Text`
DisableStr=`/userfs/bin/tcapi get String_Entry MACFilter16Text`

echo "<tr><td><table width=\"100%\" border=\"1\" align=center cellpadding=\"3\" cellspacing=\"0\" bordercolor=\"#CCCCCC\"
bgcolor=\"#FFFFFF\"><tr><TD class=table_title align=middle width=\"35%\"><STRONG>$FRuleStr</STRONG></TD><td width=\"30%\" align=center
class=\"table_title\"><strong><FONT color=\"#000000\">$MACAStr</FONT></strong></td><TD class=table_title align=middle
width=\"20%\"><STRONG><FONT color=#000000>$EnableStr</FONT></STRONG></TD><td width=\"15%\" align=center
class=\"table_title\"><strong><FONT color=\"#000000\">$DeleteStr</FONT></strong></td></TR></tr>"
