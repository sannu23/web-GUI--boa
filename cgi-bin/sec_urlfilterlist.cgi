...
NumberStr=`/userfs/bin/tcapi get String_Entry WanSetting21Text`
DeleteStr=`/userfs/bin/tcapi get String_Entry WanSetting22Text`

echo "<tr><td><table width=\"320\" border=\"1\" align=center cellpadding=\"3\" cellspacing=\"0\" bordercolor=\"#CCCCCC\"
bgcolor=\"#FFFFFF\"><tr><TD class=table_title align=middle width=60><STRONG>$NumberStr</STRONG></TD><td width=180 align=center
class=\"table_title\"><strong><FONT color=\"#000000\">URL</FONT></strong></td><TD class=table_title align=middle width=60><STRONG><FONT color=#000000>$DeleteStr</FONT></STRONG></TD></TR></tr>"
