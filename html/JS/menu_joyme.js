...
if(vPageMap[2][0] == '1'){
	if(vPageMap[2][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "网络", "/cgi-bin/nat-onetoone.asp", "");																
        else if(vPageMap[2][13] == '1')
		MenuArray[iCount++] = new MenuNodeConstruction(1, "网络", "/cgi-bin/net-l2ogre.asp", "");
}
if(vPageMap[2][1] == '1')
...
if(vPageMap[2][13] == '1')
	MenuArray[iCount++] = new MenuNodeConstruction(2, "L2oGRE配置", "/cgi-bin/net-l2ogre.asp", "");
//Sec->3
if(vPageMap[3][0] == '1'){
	if(vPageMap[3][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "安全", "/cgi-bin/mac_limit.asp", "");				
}
if(vPageMap[3][1] == '1')
...
if(vPageMap[4][0] == '1'){
	if(vPageMap[4][1] == '1')
		...
		MenuArray[iCount++] = new MenuNodeConstruction(1, "应用", "/cgi-bin/app-snmp.asp", "");	
}
if(vPageMap[4][1] == '1')
